...
local config = {
	...
	settings = {
		java = {
			...
			home = "/Library/Java/JavaVirtualMachines/temurin-24.jdk/Contents/Home", -- "/usr/lib/jvm/java-21-openjdk-amd64",
			eclipse = {
			...
			configuration = {
				...
				--       import = {
				-- maven = {
				--   enabled = true, -- make sure import is on
				--   disableTestClasspathFlag = false, -- include test deps
				--   offline = false, -- online mode so it can fetch sources
				-- },
			},
			maven = {
				downloadSources = true, -- download dependency source jars
				updateSnapshots = true, -- keep snapshots updated
			},
