...
# Guarded: a server is provisioned without oh-my-zsh more often than not, and an
# unguarded source aborts the whole file, leaving a shell with no PATH additions
# and none of the functions below.
